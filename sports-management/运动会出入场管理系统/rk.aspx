<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rk.aspx.cs" Inherits="运动会出入场管理系统.ydyr" %>
...
<body>
    ...
    <div class="auto-style1" style="font-family: 'Microsoft YaHei UI'">
        ...
        <asp:Label ID="Label1" runat="server" style="font-size: 100px" Text="入口"></asp:Label>
                    <br />
