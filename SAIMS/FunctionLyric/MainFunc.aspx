 ...
 <div id="div1">&nbsp;</div>
  <div id="mainContent">
    ...
    <div id="sidebar"><table>
      <tr><td><a href="Index.aspx" ><img src="../Images/microicons/meizhouyige.png" style="height:100px;width:256px"/></a></td></tr>
    
   <tr style="background-image: url('../Images/microicons/meizhouyige1.png'); height: 40px;"><td><ul>
     <li><a class="links" href="Lyric.html">歌词播放<br>
       Lyric Playing</a></li>
   </ul></td>
   </tr> 
     <tr  style="background-image: url('../Images/microicons/meizhouyige1.png'); height: 40px;"><td><ul>
       <li><a class="links" href="mainfunc.aspx?ID=setting">后台设置<br>
         Back Setting</a></li>
     </ul></td>
     </tr>  
</table></div>
