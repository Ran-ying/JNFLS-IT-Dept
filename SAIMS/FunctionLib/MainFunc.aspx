 ...
 <div id="div1">&nbsp;</div>
  <div id="mainContent">
    ...
    <div id="sidebar"><table>
      <tr><td><a href="Index.aspx" ><img src="../Images/microicons/tushuguan.png" style="height:100px;width:256px"/></a></td></tr>
    
   <tr style="background-image: url('../Images/microicons/tushuguan1.png'); height: 40px;"><td><ul>
     <li><a class="links" href="mainfunc.aspx?ID=io">入场登记<br>
       Entrance Checkin</a></li>
   </ul></td>
   </tr> 
     <tr  style="background-image: url('../Images/microicons/tushuguan1.png'); height: 40px;"><td><ul>
       <li><a class="links" href="mainfunc.aspx?ID=view">记录浏览<br>
         View Records</a></li>
     </ul></td>
     </tr>  
</table></div>
