...
<br /></div>
  ...
  <div id="mainContent">
    ...
    <div id="content">   
          <img src="../Images/icons/library.png" usemap="#Map" />
 <map name="Map" id="Map">
      <area shape="rect" coords="0, 0, 489, 499" href="mainfunc.aspx?ID=io" 
            alt="入场登记" />
      <area shape="rect" coords="510, 0, 999, 499" 
            href="mainfunc.aspx?ID=view" alt="记录浏览" />
     </map>
