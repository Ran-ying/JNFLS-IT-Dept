<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outbox.aspx.cs" Inherits="FunctionMessage_outbox" %>
...
<td>发件箱</td></tr></table></td></tr>
    <tr><td class="auto-style1">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="100%" Width="100%" AllowPaging="True">
            ...
            <Columns>
                <asp:HyperLinkField DataNavigateUrlFields="ID" 
                    DataNavigateUrlFormatString="view.aspx?ID={0}" Text="查看" />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Main1ConnectionString %>" SelectCommand="SELECT [ID], [发起人], [收件人], [日期], [已读] FROM [消息] WHERE (([可见] = @可见) AND ([发起人] = @发起人))">
            <SelectParameters>
                <asp:Parameter DefaultValue="true" Name="可见" Type="Boolean" />
                <asp:SessionParameter Name="发起人" SessionField="usersname" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        </td></tr>
