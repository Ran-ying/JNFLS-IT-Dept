<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ConnectUs.aspx.cs" Inherits="ConnectUs" %>
...
<head runat="server">
    <title>联系我们 - 济南外国语学校校务综合管理系统</title>
...
<body>
 <form id="form1" runat="server">
  ...
  <div id="header" class="auto-style1">
   ...
   <div id="Div1">&nbsp;</div>
  <div id="Div3" class="introtitle"><strong>联系我们</strong></div>
  <div id="Div4" class="introword"><br />新浪微博：@济外高中学生会信技部（<a href="http://weibo.com/jiwaixinxibu">http://weibo.com/jiwaixinxibu</a>）<br />
      地址：山东省济南市历城区临港街道办事处机场路6868号1号楼学生会（广播室）<br />
      电话：0531-82378208</div>
