 ...
 <table width="100%" height="100%">
    ...
    <tr><td>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [公告社团] WHERE [ID] = @ID" 
            InsertCommand="INSERT INTO [公告社团] ([部门], [名字], [内容], [日期], [标题]) VALUES (@部门, @名字, @内容, @日期, @标题)" 
            ProviderName="<%$ ConnectionStrings:Main1ConnectionString.ProviderName %>" 
            SelectCommand="SELECT [ID], [部门], [名字], [内容], [日期], [标题] FROM [公告社团]" 
            UpdateCommand="UPDATE [公告社团] SET [部门] = @部门, [名字] = @名字, [内容] = @内容, [日期] = @日期, [标题] = @标题 WHERE [ID] = @ID">
            <DeleteParameters>
    ...
    <tr><td style="text-align: center">
        ...
        <asp:Button ID="AddBtn" runat="server" Text="发布公告" onclick="Add_Click" Height="41px" Width="102px" />
