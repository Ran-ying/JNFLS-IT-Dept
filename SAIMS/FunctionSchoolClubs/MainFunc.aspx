...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style type="text/css">      
        ...
        body { font-family:微软雅黑; font-size:14px;  background-position: center center;
               background-image: url('../Images/backgrounds/clubs.jpg'); 
 ...
 <div id="div1">&nbsp;</div>
  <div id="mainContent">
    ...
    <div id="sidebar"><table>
      <tr><td><a class="links" href="index.aspx"><img src="../Images/microicons/shetuan.png" style="height:100px;width:256px"/></a></td></tr>
    
   <tr style="background-image: url('../Images/microicons/shetuan1.png'); height: 60px;"><td><ul>
     <li><a class="links" href="mainfunc.aspx?ID=show">社团展览<br>
       Associations Gallery</a></li>
   </ul></td>
   </tr> 
     <tr style="background-image: url('../Images/microicons/shetuan1.png'); height: 60px;"><td><ul>
       <li><a class="links" href="mainfunc.aspx?ID=MyClubs">我的社团<br>
         My Associations</a></li>
     </ul></td>
     </tr>  
    <tr style="background-image: url('../Images/microicons/shetuan1.png');height: 40px;"><td><ul>
      <li><a class="links" href="mainfunc.aspx?ID=allclubs">社团设置<br>
        Associations Settings</a></li>
    </ul></td>
    </tr>
    <tr style="background-image: url('../Images/microicons/shetuan1.png'); height: 60px;">
      <td><ul>
       <li><a class="links" href="mainfunc.aspx?ID=allclub">社团管理<br>
         Associations Managing</a></li>
     </ul></td>
     </tr>  
