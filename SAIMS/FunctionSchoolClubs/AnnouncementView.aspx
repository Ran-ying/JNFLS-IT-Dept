...
<table width="100%" height="100%">
    <tr style=" font-size: xx-large; font-weight: 700; color: #FFFFFF; font-family: 微软雅黑,黑体; right: 16px; text-align: center; background-color: #BB1AFF;">
         <td><asp:Label ID="titleTextBox0" ReadOnly = "true" runat="server" Width="895px" style="text-align: center; font-size: xx-large; background-color: #BB1AFF;" Font-Bold="True" Font-Names="微软雅黑" ForeColor="White"></asp:Label>
         </td>
    </tr>
