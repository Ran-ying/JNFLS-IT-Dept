...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>校园公告 - 济南外国语学校校务综合管理系统</title>
    <style type="text/css">      
        ...
        body { font-family:Verdana; font-size:14px;  background-position: center center;
               background-image: url('../Images/backgrounds/announcement.jpg'); 
...
<div id="container">
  <div id="header" class="auto-style2"><a href="../index.aspx" ><img src="../Images/titles/logo.png" style="float: left" /></a>
 ...
 <div id="div1">&nbsp;</div>
  <div id="mainContent">
    ...
    <div id="sidebar"><table>
      <tr><td><a href="Index.aspx" ><img src="../Images/microicons/gonggao.png" style="height:100px;width:256px"/></a></td></tr>
    
   <tr style="background-image: url('../Images/microicons/gonggao1.png'); height: 40px;"><td><ul>
     <li><a class="links" href="MainFunc.aspx?ID=list">查看公告<br>
       Announcements View</a></li>
   </ul></td>
   </tr> 
     <tr style="background-image: url('../Images/microicons/gonggao1.png'); height: 40px;"><td><ul>
       <li><a class="links" href="MainFunc.aspx?ID=announce">公告发布<br>
         Announcements Publishing</a></li>
     </ul></td>
     </tr>  
</table>
</div>
