...
<body>
  ...
  <div id="mainContent">
    ...
    <div id="content">  <img  src="../Images/icons/announcement.png" usemap="#Map" border="0"/>
    <map name="Map" id="Map">
      <area shape="rect" coords="0, 0, 491, 497" href="MainFunc.aspx?ID=list" />
      <area shape="rect" coords="502, 3, 998, 499" href="MainFunc.aspx?ID=announce" />
    </map>
    </div>
  </div>
  <div id="Div2">&nbsp;</div>
