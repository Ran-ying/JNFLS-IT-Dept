...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>广播 - 济南外国语学校校务综合管理系统</title>
    <style type="text/css">      
        ...
        body { font-family: 微软雅黑,黑体; font-size:14px;  background-position: center center;
               background-image: url('../Images/backgrounds/Broadcast.jpg'); 
...
<div id="container">
  <div id="header" class="auto-style1"><a href="../index.aspx" ><img src="../Images/titles/logo.png" style="float: left" /></a>
      <view:viewinfo ID="Viewinfo1" runat="server"/>v
<br /><br /><br />
<br /></div>
 <div id="div1">&nbsp;</div>
  <div id="mainContent">
    ...
    <div id="sidebar"><table>
      <tr><td><a href="Index.aspx"><img src="../Images/microicons/guangbo.png" style="height:100px;width:256px"/></a></td></tr>
    
   <tr style="background-image: url('../Images/microicons/guangbo1.png'); height: 40px;"><td><ul>
     <li><a class="links" href="mainfunc.aspx?ID=apply">申请广播<br>
       Broadcast Application</a></li>
   </ul></td>
   </tr> 
     <tr style="background-image: url('../Images/microicons/guangbo1.png'); height: 40px;"><td><ul>
       <li><a class="links" href="mainfunc.aspx?ID=manage">审核广播<br>
         Broadcast Verification</a></li>
     </ul></td>
     </tr>  
    <tr style="background-image: url('../Images/microicons/guangbo1.png');height: 40px;"><td><ul>
      <li><a class="links" href="mainfunc.aspx?ID=announce">发布广播<br>
        Broadcast Announcing</a></li>
    </ul></td>
    </tr>
</table></div>
